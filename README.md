...
reconstruct the graphs demonstrated in the original fork of this repository
...
*Each script should be able to read and save the data for reproduction
...
electric power consumption Data Set" which is availible from below
